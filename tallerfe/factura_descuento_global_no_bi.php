<?php
	...
	$cabecera = array(
				...
				"serie"				=> "F001",
				"correlativo"		=> 1234,
				"total_op_gravadas_sd" => 50.17,
				"total_op_gravadas" => 50.17,
				"igv"				=> 9.03,
				"icbper"			=> 0.30,
				"descuento_global_bi"	=> 0.00,
				"descuento_global_no_bi" => 100.00,
				"factor_descuento_global"=> 0.00,
				"motivo_descuento"	=>"03",
...
<Invoice xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ccts="urn:un:unece:uncefact:documentation:2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:qdt="urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2" xmlns:udt="urn:un:unece:uncefact:data:specification:UnqualifiedDataTypesSchemaModule:2" xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2">
	...
	if($cabecera['descuento_global_no_bi']>0 || $cabecera['descuento_global_bi']>0){
	$xml.='<cac:AllowanceCharge>
	     <cbc:ChargeIndicator>false</cbc:ChargeIndicator>
	     <cbc:AllowanceChargeReasonCode listName="Cargo/descuento" listAgencyName="PE:SUNAT"   
	        listURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo53">'.$cabecera['motivo_descuento'].'</cbc:AllowanceChargeReasonCode>';
	     if($cabecera['factor_descuento_global']>0){
	     $xml.='<cbc:MultiplierFactorNumeric>'.$cabecera['factor_descuento_global'].'</cbc:MultiplierFactorNumeric>';
	 		}
	 	if($cabecera['descuento_global_bi']>0){
	     	$xml.='<cbc:Amount currencyID="PEN">'.$cabecera['descuento_global_bi'].'</cbc:Amount>';
	    }else{
	    	$xml.='<cbc:Amount currencyID="PEN">'.$cabecera['descuento_global_no_bi'].'</cbc:Amount>';
	    }

	     if($cabecera['motivo_descuento']=='02'){
	     	'<cbc:BaseAmount currencyID="PEN">'.$cabecera['total_op_gravadas_sd'].'</cbc:BaseAmount>';
	 		}
	$xml.='</cac:AllowanceCharge>';
	}
	$xml.='<cac:TaxTotal>
	...
	<cac:LegalMonetaryTotal>
		...
		<cbc:AllowanceTotalAmount currencyID="'.$cabecera['moneda'].'">'.$cabecera['descuento_global_no_bi'].'</cbc:AllowanceTotalAmount>
