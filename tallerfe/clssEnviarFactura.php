...
$cabecera = array(
    "forma_pago" => "Contado",
    "tipo_operacion"    => "0101", // Venta que esta sujeta a IGV
...
fn_enviar_factura($emisor,$cliente,$cabecera,$items);
function fn_enviar_factura($emisor, $cliente, $cabecera, $items)
{
    $carpetaxml = "xml/";
    $carpetacdr = "cdr/";
    ...
    $pass_firma = $emisor["clave_firma_digital"];
