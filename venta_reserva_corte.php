            ...
            <div class="modal-body">
                <div
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body text-center">
                            <h4 class="card-title" style="font-size: 25px;"> <i class="fas fa-save"></i> Realizar Reserva</h4>
                        </div>
                        <!--<div class="card-body text-center">
                        ...
                        <div class="text-center">
                            <a class="btn btn-success rounded-5" id="Reservar" role="button"> <i class="fas fa-save"></i> Reservar</a>
                        </div>
            ...
            document.getElementById('modalContent').innerHTML = `
                <div class="text-center">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text"><b> Cantidad de Ploteo </b> </p>
                            <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="card-body">
                            <p class="card-text"><b> Dimensión </b> </p>
                            <div class="selectgroup selectgroup-pills" >
                                <label class="selectgroup-item">
                                    <input
                                        type="checkbox"
                        ...
                        <div class="card-body">
                            <p class="card-text"><b> Monto (S/) </b> </p>
            ...
            document.getElementById('modalContent').innerHTML = `
                <div class="text-center">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text"><b>Cantidad a Imprimir</b></p>
                            <div class="d-flex align-items-center justify-content-center">
            ...
            document.getElementById('modalContent').innerHTML = `
                <div class="text-center">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text"><b>Cantidad de Escaneo</b></p>
                            <div class="d-flex align-items-center justify-content-center">
