    ...
    <div class="page-inner">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-round">
                    <div class="card-body">
                        <div class="card-title fw-mediumbold">Categorias</div>
                        <div class="card-list">
                            ...
                            ?>
                                <div class="item-list">
                                    ...
                                    <div class="info-user ms-3">
                                        <div class="username">Categoria <?php echo $i ?></div>
...
<script>
    ...
    function fn_sumar_datos_table() {
        ...
        for (var i = 1; i < tabla.rows.length; i++) {
            var valor = parseFloat(tabla.rows[i].cells[3].innerText); // Convertir a número
            console.log("valor: " + tabla.rows[i].cells[3].innerText);
