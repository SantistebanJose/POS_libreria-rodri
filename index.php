                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <a href="cotizacion.php">
                                <button class="btn btn-lg w-100" style="background: linear-gradient(135deg, #000d49 0%, #000933 100%); color: white; border: none;">
                                    <div class="icon-big text-center">
                                        <i class="fas fa-file-invoice-dollar"></i>
                                    </div>
                                    <h6>Cotizar Lista Escolar</h6>
                                </button>
                            </a>
                        </div>
                        <div class="col-sm-6 col-md-4">
                            <a href="deudas_proveedores.php">
                                <button class="btn btn-danger btn-lg w-100">
                                    <div class="icon-big text-center">
                                        <i class="fas fa-credit-card"></i>
                                    </div>
                                    <h6>Deudas a Proveedores</h6>
                                </button>
                            </a>
                        </div>
                    </div>
